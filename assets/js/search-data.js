...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-our-new-paper-bot-breaking-long-thought-processes-of-o1-like-large-language-models-through-backdoor-attack-is-available-on-arxiv-check-out-the-code-on-github",
          title: 'Our new paper “BoT: Breaking Long Thought Processes of o1-like Large Language Models...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%7A%69%68%61%6F%7A%68%75@%6C%69%6E%6B.%63%75%68%6B.%65%64%75.%63%6E", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/zihao-ai# your GitHub user name", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=lBSoR4IAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
